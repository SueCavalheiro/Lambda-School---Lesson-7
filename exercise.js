...
console.log(stepsToWorldDomination.toString());
...
// test prototype removeClass
// elementD.addClass('casa');
// elementD.addClass('carro');
// elementD.addClass('cachorro');
// console.log(elementD.toString());
// console.log(elementD);

// elementD.removeClass('cachorro');
// console.log(elementD);
...
HtmlElement.prototype.toStringChildren = function() {
  const openingTag = getOpeningTag(this.type, this.id, this.classes);
  const closingTag = "</" + this.type + ">";

  return openingTag + this.text + this.children.join('') + closingTag;
...
console.log(stepsToWorldDomination.toStringChildren());
